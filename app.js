...
function renderLibrary() {
  ...
  libraryGroups(filter, mode).forEach(({ folder, sets, ungrouped }) => {
    ...
    const color = safeColour(folder?.color, '#a0a6b4'); const title = ungrouped ? 'Ungrouped sets' : folder.name; const collapsed = Boolean(folder?.collapsed);
